			...
			<View style={styles.container}>
             ...
             <Text onPress={this.login} style={styles.buttonText}>Connectez-vous</Text>
				...
				<View style={styles.signupTextCont}>
					...
					<TouchableOpacity onPress={this.signup}><Text style={styles.signupButton}> Inscrivez-vous</Text></TouchableOpacity>
				</View>
			</View>	
			)
	}
...
login = () =>{
  request.get("http://192.168.137.133:3000/api/login")
  .query({
  ...
  .finish((error, res)=>{
    console.log(res);
      if(res.body.success === true) {
        console.log("succeed datas recuperées");
      var first_name = res.message;
      AsyncStorage.setItem('email', first_name);
      this.setState({ 'email': first_name });
        ...
        [
          ...
          {text: this.state.email, onPress: () => console.log('OK Pressed')},
        ],
        { cancelable: false });
